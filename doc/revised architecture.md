...
# Revised Kuavo Architecture Documents

Based on all architecture discussions, here are the three revised documents reflecting the updated motor count (12), rate changes, telemetry replacement, per-source staging buffers, cross-process Mercury Controller bridge, and MQTT binary logger.
